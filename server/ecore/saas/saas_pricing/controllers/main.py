...
from ecore.addons.auth_oauth.controllers import main as oauth
from ecore.addons.auth_signup.controllers import main as signup
import werkzeug
import simplejson
import uuid
import random
...
class SaasPortal(http.Controller):
    ...
    def exists_database(self, dbname):
        full_dbname = self.get_full_dbname(dbname)
        return ecore.service.db.exp_db_exist(full_dbname)
