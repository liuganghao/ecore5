# -*- coding: utf-8 -*-
import ecore
from ecore import models, fields, api, SUPERUSER_ID, exceptions
from ecore.addons.saas_utils import connector, database
from ecore import http
from ecore.tools import config, scan_languages
from ecore.tools.translate import _
from ecore.addons.base.res.res_partner import _tz_get
import time
...
from datetime import datetime, timedelta
from ecore.tools import DEFAULT_SERVER_DATETIME_FORMAT
from ecore.addons.saas_base.exceptions import MaximumDBException
...
class SaasPortalPlan(models.Model):
    ...
    dbname_template = fields.Char('DB Names', help='Used for generating client database domain name. Use %i for numbering. Ignore if you use manually created db names', placeholder='crm-%i.ecore.com')
...
class SaasPortalClient(models.Model):
    ...
    def unlink(self, cr, uid, ids, context=None):
        ...
        for obj in self.browse(cr, uid, ids):
            ...
            #ecore.service.db.exp_drop(obj.name)
