...
from ecore.addons.web.controllers.main import ensure_db, set_cookie_and_redirect, login_and_redirect
...
class OAuth2(http.Controller):
    ...
    def auth(self, **kw):
        ...
        # redirect_uri: https://example.ecore.com/auth_oauth/signin
        # response_type: token
