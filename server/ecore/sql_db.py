...
"""
The PostgreSQL connector is a connectivity layer between the eCore code and
...
class Cursor(object):
    """Represents an open transaction to the PostgreSQL DB backend,
       ...
       ``cursor`` objects.
        ...
        such as eCore, we need the best guarantees that no data
        ...
        eCore implements its own level of locking protection
        ...
        the default transaction isolation level for eCore cursors, as
...
def close_db(db_name):
    """ You might want to call ecore.modules.registry.RegistryManager.delete(db_name) along this function."""
    global _Pool
    if _Pool:
