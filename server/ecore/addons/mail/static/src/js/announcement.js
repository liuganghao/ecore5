ecore.define('mail.announcement', function (require) {
"use strict";
        ...
        return config_parameter.call('get_param', ['database.uuid', false]).then(function(dbuuid) {
            ...
            $css.on('load', function() {
                var close = function() {
                    ...
                    $bar.slideUp();
                    setTimeout(function () {
                        $('.ecore_webclient_container').css('height', 'calc(100% - 34px)');                            
                    }, 400);
                };
                /*
                ...
                */
                setTimeout(function(){
                    ...
                    $('.ecore_webclient_container').css('height', 'calc(100% - ' + height + 'px)');
