...
from ecore import release, SUPERUSER_ID
from ecore.models import AbstractModel
from ecore.tools.translate import _
from ecore.tools.config import config
...
class publisher_warranty_contract(AbstractModel):
    ...
    def update_notification(self, cr, uid, ids, cron_mode=True, context=None):
        """
        Send a message to eCore's publisher warranty server to check the
