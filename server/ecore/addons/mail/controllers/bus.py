...
class MailChatController(ecore.addons.bus.controllers.main.BusController):
    ...
    # --------------------------
    @ecore.http.route('/mail/chat_post', type="json", auth="none")
    ...
    @ecore.http.route(['/mail/chat_history'], type="json", auth="none")
    ...
    @ecore.http.route('/mail/chat_init', type="json", auth="none")
