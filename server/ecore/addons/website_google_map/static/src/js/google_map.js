function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('ecore-google-map'), {
        zoom: 1,
    ...
    if (ecore_partner_data){ /* ecore_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < ecore_partner_data.counter; i++) {
            set_marker(ecore_partner_data.partners[i]);
        }
