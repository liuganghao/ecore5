...
from ecore.osv.expression import get_unaccent_wrapper
...
class res_partner(osv.Model, format_address):
    ...
    _columns = {
        ...
        'company_type': fields.selection(
            selection=[('person', 'Contacto'),
                       ('company', 'Company')],
            string='Company Type',
            help='Tipo de contacto '
                 'Selecciona Tercero si tu compañia tiene alguna relacion comercial con esta '
                 'Selecciona Contacto si solo es un registro que quieres gurdar en tus contactos'
                 'Puedes cambiar el tipo de contacto en cualquier momento '
                 'mediente el boton Editar '),
    ...
    def _get_default_image(self, is_company, colorize=False):
        img_path = ecore.modules.get_module_resource(
