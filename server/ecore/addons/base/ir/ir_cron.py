...
import ecore
from ecore import SUPERUSER_ID, netsvc, api
...
from ecore.modules import load_information_from_description_file
...
class ir_cron(osv.osv):
    ...
    def _callback(self, cr, uid, model_name, method_name, args, job_id):
        ...
        try:
            args = str2tuple(args)
            ecore.modules.registry.RegistryManager.check_registry_signaling(cr.dbname)
            ...
            if model_name in registry:
                ...
                if hasattr(model, method_name):
                    ...
                    ecore.modules.registry.RegistryManager.signal_caches_change(cr.dbname)
                else:
    ...
    def _acquire_job(cls, db_name):
        ...
        try:
            ...
            if e.pgcode == '42P01':
                ...
                # The table ir_cron does not exist; this is probably not an eCore database.
        ...
        for job in jobs:
            ...
            try:
                ...
                job_cr = db.cursor()
                try:
                    registry = ecore.registry(db_name)
