...
from ecore.tools import DEFAULT_SERVER_DATE_FORMAT, DEFAULT_SERVER_DATETIME_FORMAT, ustr
...
class ir_fields_converter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str):
        ...
        callable taking a record-ish (a dictionary representing an ecore
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`ecore.osv.orm.Model.write` expects.

        :param model: :class:`ecore.osv.orm.Model` for the conversion base
    ...
    def to_field(self, model, field, fromtype=str):
        ...
        :type field: :class:`ecore.fields.Field`
        :param fromtype: type to convert to something fitting for ``field``
        :type fromtype: type | str
        :param context: ecore request context
