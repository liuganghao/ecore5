...
import ecore
from ecore import tools, api
from ecore.exceptions import ValidationError
from ecore.http import request
from ecore.modules.module import get_resource_path, get_resource_from_path
from ecore.osv import fields, osv, orm
from ecore.tools import config, graph, SKIPPED_ELEMENT_TYPES, SKIPPED_ELEMENTS
from ecore.tools.convert import _fix_multiple_roots
from ecore.tools.parse_version import parse_version
from ecore.tools.safe_eval import safe_eval as eval
from ecore.tools.view_validation import valid_view
from ecore.tools import misc
from ecore.tools.translate import TRANSLATED_ATTRS, encode, xml_translate, _
...
* if False, the view currently does not extend its parent but can be enabled
    ...
    def render(self, cr, uid, id_or_xml_id, values=None, engine='ir.qweb', context=None):
        ...
        def get_modules_order():
            if request:
                from ecore.addons.web.controllers.main import module_boot
