    ...
    def load_module_terms(self, cr, modules, langs, context=None):
        ...
        for module_name in modules:
            ...
            for lang in langs:
                ...
                if base_lang_code:
                    base_trans_file = ecore.modules.get_module_resource(module_name, 'i18n', base_lang_code + '.po')
                    if base_trans_file:
                    ...
                    base_trans_extra_file = ecore.modules.get_module_resource(module_name, 'i18n_extra', base_lang_code + '.po')
                ...
                trans_file = ecore.modules.get_module_resource(module_name, 'i18n', lang_code + '.po')
                if trans_file:
                ...
                trans_extra_file = ecore.modules.get_module_resource(module_name, 'i18n_extra', lang_code + '.po')
                if trans_extra_file:
