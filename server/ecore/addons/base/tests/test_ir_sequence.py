...
#    > ECORE_ADDONS_PATH='../../addons/trunk' ECORE_PORT=8069 \
#      ECORE_DATABASE=yy PYTHONPATH=. python tests/test_ir_sequence.py
#    > ECORE_ADDONS_PATH='../../addons/trunk' ECORE_PORT=8069 \
#      ECORE_DATABASE=yy nosetests tests/test_ir_sequence.py
#    > ECORE_ADDONS_PATH='../../../addons/trunk' ECORE_PORT=8069 \
#      ECORE_DATABASE=yy PYTHONPATH=../:. unit2 test_ir_sequence
...
def registry(model):
    return ecore.modules.registry.RegistryManager.get(common.get_db_name())[model]

def cursor():
    return ecore.modules.registry.RegistryManager.get(common.get_db_name()).cursor()
