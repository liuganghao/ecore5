...
import ecore.tests.common as common
...
workflow"""
    ...
    def test_20_trigger(self):
        ...
        # Clear workflow cache, otherwise ecore will try to create workflows even if it has been deleted
        from ecore.workflow import clear_cache
        clear_cache(cr, uid)
