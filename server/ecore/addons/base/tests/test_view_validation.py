...
# > PYTHONPATH=. python2 ecore/tests/test_view_validation.py
from lxml import etree
from StringIO import StringIO
import unittest

from ecore.tools.view_validation import (valid_page_in_book, valid_att_in_form, valid_type_in_colspan,
