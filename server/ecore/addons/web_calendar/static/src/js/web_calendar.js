ecore.define('web_calendar.CalendarView', function (require) {
"use strict";
/*---------------------------------------------------------
 * eCore web_calendar
 *---------------------------------------------------------*/
...
var CalendarView = View.extend({
    ...
    /**
     * Refresh one fullcalendar event identified by it's 'id' by reading eCore record state.
    ...
    /**
     * Transform eCore event object to fullcalendar event object
     */
    ...
    /**
     * Transform fullcalendar event object to eCore Data object
     */
    ...
    /**
     * Build eCore Domain to filter object by this.date_start field
