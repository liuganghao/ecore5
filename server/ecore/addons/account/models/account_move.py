...
from ecore.exceptions import RedirectWarning, UserError
from ecore.tools.misc import formatLang
from ecore.tools import float_is_zero
...
class AccountMoveLine(models.Model):
    ...
    def create(self, vals, apply_taxes=True):
        ...
        if apply_taxes and not context.get('dont_create_taxes') and vals.get('tax_ids'):
            # Get ids from triplets : http://www.ecore.cool/documentation/master/reference/orm.html#ecore.models.Model.write
