...
The eCore <a href="http://www.ecore.cool/page/accounting">Open Source Accounting</a> app allows a better way to
...
in one place. eCore's user interface is designed with productivity in mind.
...
accounting; eCore has all the features you need to sustain all your business
activities.

Scale With Your Organization
----------------------------

eCore supports multiple currencies, multiple users with different access rights,
