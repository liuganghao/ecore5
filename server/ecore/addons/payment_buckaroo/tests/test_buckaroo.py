...
from ecore.addons.payment_buckaroo.controllers.main import BuckarooController
from ecore.tools import mute_logger


@ecore.tests.common.at_install(False)
@ecore.tests.common.post_install(False)
...
class BuckarooForm(BuckarooCommon):
    ...
    @mute_logger('ecore.addons.payment_buckaroo.models.buckaroo', 'ValidationError')
    def test_20_buckaroo_form_management(self):
        ...
        buckaroo_post_data = {
            ...
            'BRQ_SERVICE_PAYPAL_PAYEREMAIL': u'fhe@ecore.cool',
