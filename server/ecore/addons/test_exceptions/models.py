...
import ecore.osv.orm
import ecore.osv.osv
import ecore.tools.safe_eval
from ecore.exceptions import UserError
from ecore.exceptions import except_orm

class m(ecore.osv.osv.Model):
    ...
    def generate_except_osv(self, cr, uid, ids, context=None):
        ...
        raise ecore.osv.osv.except_osv('title', 'description')
    ...
    def generate_warning(self, cr, uid, ids, context=None):
        raise ecore.exceptions.Warning('description')
    ...
    def generate_redirect_warning(self, cr, uid, ids, context=None):
        ...
        raise ecore.exceptions.RedirectWarning('description', action_id, 'Go to the redirection')
    ...
    def generate_access_error(self, cr, uid, ids, context=None):
        raise ecore.exceptions.AccessError('description')
    ...
    def generate_missing_error(self, cr, uid, ids, context=None):
        raise ecore.exceptions.MissingError('description')

    def generate_validation_error(self, cr, uid, ids, context=None):
        raise ecore.exceptions.ValidationError('description')
    ...
    def generate_safe_eval(self, cr, uid, ids, f, context):
        ...
        ecore.tools.safe_eval.safe_eval("generate()", mode='exec', globals_dict=globals_dict)
