ecore.define('point_of_sale.models', function (require) {
"use strict";
...
exports.PosModel = Backbone.Model.extend({
    ...
    models: [
    {
        ...
        loaded: function(self){
            ...
            self.company_logo.src = '/web/static/src/img/logo.png' +'?_'+Math.random();
...
//
// models: [{
//  model: [string] the name of the ecore model to load.
...
//  context: [Dict|function] the ecore context for the model read
