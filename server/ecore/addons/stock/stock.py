...
from ecore.tools.float_utils import float_compare, float_round
from ecore.tools.translate import _
from ecore.tools import DEFAULT_SERVER_DATETIME_FORMAT, DEFAULT_SERVER_DATE_FORMAT
from ecore import SUPERUSER_ID, api, models
import ecore.addons.decimal_precision as dp
from ecore.addons.procurement import procurement
import logging
                ...
                if product_qty < move['product_qty']:
                    warning.update({
                        ...
                        'message': _("By changing this quantity here, you accept the "
                                "new quantity as complete: eCore will not "
...
class stock_warehouse_orderpoint(osv.osv):
    ...
    _columns = {
        ...
        'product_min_qty': fields.float('Minimum Quantity', required=True,
            ...
            help="When the virtual stock goes below the Min Quantity specified for this field, eCore generates "\
            "a procurement to bring the forecasted quantity to the Max Quantity."),
        'product_max_qty': fields.float('Maximum Quantity', required=True,
            digits_compute=dp.get_precision('Product Unit of Measure'),
            help="When the virtual stock goes below the Min Quantity, eCore generates "\
