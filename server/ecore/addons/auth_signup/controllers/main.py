...
import ecore
from ecore.addons.auth_signup.res_users import SignupError
from ecore.addons.web.controllers.main import ensure_db
...
class AuthSignupHome(ecore.addons.web.controllers.main.Home):
    ...
    def get_auth_signup_qcontext(self):
        ...
        if qcontext.get('token'):
            try:
                ...
                token_infos = res_partner.signup_retrieve_info(request.cr, ecore.SUPERUSER_ID, qcontext.get('token'))
    ...
    def do_signup(self, qcontext):
        ...
        supported_langs = [lang['code'] for lang in request.registry['res.lang'].search_read(request.cr, ecore.SUPERUSER_ID, [], ['code'])]
    ...
    def _signup_with_values(self, token, values):
        db, login, password = request.registry['res.users'].signup(request.cr, ecore.SUPERUSER_ID, values, token)
