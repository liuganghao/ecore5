...
var UserMenu = Widget.extend({
    ...
    on_menu_documentation: function () {
        window.open('https://www.ecore.com/documentation/user', '_blank');
    },
    on_menu_support: function () {
        window.location.href = 'mailto:help@ecore.com';
    },
    ...
    on_menu_account: function() {
        ...
        P.call('get_param', ['database.uuid']).then(function(dbuuid) {
            ...
            window.location.href = 'https://accounts.ecore.com/oauth2/auth?'+$.param(params);
        }).fail(function(result, ev){
            ev.preventDefault();
            window.location.href = 'https://accounts.ecore.com/account';
        });
    },
