ecore.define('web.ControlPanelMixin', function (require) {
"use strict";
...
ecore.define('web.ControlPanel', function (require) {
"use strict";
...
var ControlPanel = Widget.extend({
     ...
     * @param {ecore.web.SearchView} [status.searchview] the searchview widget
     ...
     * @param {ecore.web.SearchView} [searchview] the searchview Widget
