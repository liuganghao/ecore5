/* config dom id (optional) + config tensores params */
tensoresJS('tensor-flow', {
  tensores: {
  ...
  interactivity: {
    ...
    events: {
      ...
      onresize: {
        ...
        density_auto: false,
        density_area: 800 // nb_tensores = tensores.nb * (canvas width *  canvas height / 1000) / density_area
      }
    }
  },
