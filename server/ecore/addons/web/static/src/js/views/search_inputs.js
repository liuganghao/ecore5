ecore.define('web.search_inputs', function (require) {
"use strict";
...
/**
 * Implementation of the ``char`` eCore field type:
 *
...
/**
 * Implementation of the ``datetime`` ecore field type:
 *
...
var FilterGroup = Input.extend(/** @lends instance.web.search.FilterGroup# */{
     ...
     *
     * @param {ecore.web.search.Facet} facet
...
var Filter = Input.extend(/** @lends instance.web.search.Filter# */{
    ...
    /**
     * Implementation of the eCore filters (button with a context and/or
