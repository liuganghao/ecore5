ecore.define_section('eval.basics', ['web.pyeval'], function(test, mock) {
...
ecore.define_section('eval.types', ['web.pyeval'], function (test, mock) {
...
ecore.define_section('eval.edc', ['web.pyeval', 'web.session'], function (test, mock) {
...
ecore.define_section('eval.edc.nonliterals', ['web.pyeval', 'web.session'], function (test, mock) {
    function setup(session) {
...
ecore.define_section('eval.contexts', ['web.pyeval'], function (test) {
...
ecore.define_section('eval.domains', ['web.pyeval'], function (test) {
...
ecore.define_section('eval.groupbys', ['web.pyeval'], function (test) {
