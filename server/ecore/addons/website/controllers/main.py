...
import ecore
from ecore.addons.base.ir.ir_qweb import AssetsBundle
from ecore.addons.web.controllers.main import WebClient, Binary
...
#------------------------------------------------------
class WebsiteBinary(ecore.http.Controller):
    @http.route([
        '/website/image',
        '/website/image/<xmlid>',
