...
from ecore.sql_db import TestCursor
...
#--------------------------------------------------------------------------
# Check the presence of Wkhtmltopdf and return its version at eCore start-up
#--------------------------------------------------------------------------
...
try:
    ...
    if config['workers'] == 1:
        _logger.info('You need to start eCore with at least two workers to print a pdf version of the reports.')
