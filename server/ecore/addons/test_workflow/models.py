...
class m(ecore.osv.orm.Model):
    ...
    def trigger(self, cr, uid, context=None):
        return ecore.workflow.trg_trigger(uid, 'test.workflow.trigger', 1, cr)

class n(ecore.osv.orm.Model):
    """ A model used for the trigger feature. """
    _name = 'test.workflow.trigger'
    _columns = { 'value': ecore.osv.fields.boolean('Value') }
    _defaults = { 'value': False }

class a(ecore.osv.orm.Model):
    _name = 'test.workflow.model.a'
    _columns = { 'value': ecore.osv.fields.integer('Value') }
    _defaults = { 'value': 0 }

class b(ecore.osv.orm.Model):
    _name = 'test.workflow.model.b'
    _inherit = 'test.workflow.model.a'

class c(ecore.osv.orm.Model):
    _name = 'test.workflow.model.c'
    _inherit = 'test.workflow.model.a'

class d(ecore.osv.orm.Model):
    _name = 'test.workflow.model.d'
    _inherit = 'test.workflow.model.a'

class e(ecore.osv.orm.Model):
...
for name in 'bcdefghijkl':
    ...
    #
    class NewModel(ecore.osv.orm.Model):
