...
from ecore.addons.payment_authorize.controllers.main import AuthorizeController
from ecore.tools import mute_logger


@ecore.tests.common.at_install(True)
...
class AuthorizeForm(AuthorizeCommon):
    ...
    @mute_logger('ecore.addons.payment_authorize.models.authorize', 'ValidationError')
