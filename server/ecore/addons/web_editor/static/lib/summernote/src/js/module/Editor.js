define([
  ...
  var Editor = function (handler) {
    ...
    this.style = style;   // eCore: allow access for override
    this.table = table;   // eCore: allow access for override
    this.typing = typing; // eCore: allow access for override
    this.bullet = bullet; // eCore: allow access for override
    ...
    this.saveRange = function ($editable, thenCollapse) {
      // eCore: scroll to top when click on input in editable m (start_modification
      // this.focus($editable);
      var r = range.create();
      if (!r || ($editable[0] !== r.sc && !$.contains($editable[0], r.sc))) {
        $editable.focus();
      }
      // eCore: end_modication)
    ...
    this.createLink = function ($editable, linkInfo, options) {
      ...
      var className = linkInfo.className || null; // eCore: addition
      ...
      var anchors = [];
      // eCore: adding this branch to modify existing anchor
      ...
      $.each(anchors, function (idx, anchor) {
        ...
        $(anchor).attr('class', className); // eCore: addition
        if (isNewWindow) {
