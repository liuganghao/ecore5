ecore.define('web_editor.iframe', function (require) {
'use strict';
...
editor.Class.include({
    start: function () {
        this.on('rte:start', this, function () {
            ...
            if (window.top.ecore[callback+"_editor"]) {
                window.top.ecore[callback+"_editor"](this);
            }
            ...
            $editable.on('content_changed', this, function () {
                if (window.top.ecore[callback+"_downup"]) {
                    window.top.ecore[callback+"_downup"]($editable.prop('innerHTML'));
                }
            });
        });
