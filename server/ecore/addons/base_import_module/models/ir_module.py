...
import ecore
from ecore import fields
from ecore.osv import osv
from ecore.tools import convert_file, exception_to_unicode
...
class ir_module_module(osv.osv):
    ...
    def import_module(self, cr, uid, module, path, force=False, context=None):
        ...
        terp = ecore.modules.load_information_from_description_file(module, mod_path=path)
