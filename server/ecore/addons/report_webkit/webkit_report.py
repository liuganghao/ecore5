...
import ecore
from ecore.modules.module import get_module_resource
from ecore.report.report_sxw import *
...
class WebKitParser(report_sxw):
    ...
    def create(self, cursor, uid, ids, data, context=None):
        ...
        pool = ecore.registry(cursor.dbname)
