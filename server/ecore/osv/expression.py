...
term representation was ['=', 'company_id.name', 'eCore']. Used in a
...
eCore will use the SQL function 'unaccent' when available for the
...
Finally, to instruct eCore to really use the unaccent function, you have to
...
def get_unaccent_wrapper(cr):
    if ecore.modules.registry.RegistryManager.get(cr.dbname).has_unaccent:
