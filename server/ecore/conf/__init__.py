...
For now, configuration code is in ecore.tools.config. It is in mainly
...
To initialize properly this module, ecore.tools.config.parse_config()
must be used.
...
# Paths to search for eCore addons.
addons_paths = []
...
# installed (i.e. the majority of eCore addons). This is set with the --load
# command-line option.
server_wide_modules = []
