...
from ecore.modules.module import get_module_root, MANIFEST
from ecore.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the eCore server for your project"""
