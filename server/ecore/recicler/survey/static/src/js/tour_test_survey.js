ecore.define('survey.tour_test_survey', function (require) {
'use strict';
...
Tour.register({
    ...
    steps: [
        ...
        // Page-2
        // Question: What do you think about the documentation available on doc.ecore.cool?
        {
        ...
        {
            title:     "For 'I use the contextual help in eCore' checking 'Agree'",
        ...
        // Question: What do you think about the process views of eCore, available in the web client ?
        {
            title:     "For 'They help new users to understand eCore' checking 'Totally disagree'",
        ...
        // Page-3
        // Question: How do you contribute or plan to contribute to eCore?
        {
