...
from ecore.addons.payment_adyen.controllers.main import AdyenController
...
class AdyenForm(AdyenCommon):
    ...
    # @mute_logger('ecore.addons.payment_adyen.models.adyen', 'ValidationError')
